...
class FlxSplash extends FlxState {
	...
	override public function create():Void {
		...
		_colors = [0xFF00C8, 0xffffff, 0x5700a8, 0x266e3c, 0xad68ad];
		...
		_text.text = "hyper fucking amazing!";
	...
	override public function update(_:Float):Void {
		_sprite.scaleX = FlxMath.lerp(1, _sprite.scaleX, 0.93);
		_sprite.scaleY = FlxMath.lerp(1, _sprite.scaleY, 0.93);
        FlxG.stage.rotation = 20;
		super.update(_);
	}
