...
class Note extends FlxSprite
{
	...
	public var strumTime:Null<Float> = 0;
	public var noteData:Int = 0;

	public var earlyHitMult:Null<Float> = 0.5;
	public var lateHitMult:Float = 1;

	public var mustPress:Null<Bool> = false;
	public var canBeHit:Null<Bool> = false;
	public var tooLate:Null<Bool> = false;
	public var wasHit:Null<Bool> = false;
	public var wasGoodHit:Null<Bool> = false;
	public var ignoreNote:Null<Bool> = false;

	public var altNote:Null<Bool> = false;

	public var offsetX:Null<Float> = 0;
	public var offsetY:Null<Float> = 0;
	public var offsetAngle:Null<Float> = 0;
	public var multAlpha:Null<Float> = 1;
	public var distance:Null<Float> = 2000;
	...
	public var multSpeed:Null<Float> = 1;

	public var susNote:Null<Float> = 0;

	public static var waveThing:Float = 0;

	public var unheldTime:Null<Float>;
	...
	public var scrollSpeed:Null<Float> = 1;
	public var texture(default, set):String;
	public var sustainLength:Null<Float> = 0;
	...
	public static inline function initializeGlobalRGBShader(noteData:Int, isPixel:Bool = false)
	{
		if (isPixel)
			noteData += 4;
	...
	public inline function reloadRGB()
	{
	...
	public inline function followStrumNote(myStrum:Receptor, fakeCrochet:Float, songSpeed:Float = 1)
	{
		try
		{
	...
	inline function  normal(tex:String = "NOTE_assets")
	{
	...
	inline function pixel(tex:String = "NOTE_assets")
	{
		if (isSustainNote)
		{
	...
	inline public function setupNote()
	{
		return this;
	}
	...
	inline public function clipToStrumNote(myStrum:Receptor)
	{
		...
		if ((mustPress || !mustPress) && (wasGoodHit || (prevNote.wasGoodHit && !canBeHit)))
		{
			...
			swagRect = swagRect.getRotatedBounds(myStrum.direction - 90);
			clipRect = swagRect;
		}
	}
	...
	inline public function reloadNote(tex:String = "NOTE_assets")
	{
		if (isPixel == false)
			normal(tex);
		else
